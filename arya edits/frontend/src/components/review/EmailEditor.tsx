    ...
    <div className="h-full flex flex-col">
      ...
      <div className="p-5 border-b border-border">
        ...
        <div>
          ...
          <Input
            ...
            className="glass-card border-white/[0.08] focus:border-primary/50 font-medium"
          />
        </div>
      </div>
      ...
      <div className="flex-1 p-5">
        ...
        <Textarea
          ...
          className="h-full min-h-[300px] resize-none glass-card border-white/[0.08] focus:border-primary/50 text-sm leading-relaxed"
        />
      </div>
