                ...
                try {
                    ...
                    if (found) {
                        ...
                        try {
                            ...
                            const historyMessages: Message[] = logs.map((log: Log) => ({
                                id: log.id,
                                ...
                                status: (log.type === "success" ? "complete"
                                    : log.type === "error" ? "error"
                                        : log.type === "thinking" ? "thinking"
                                            : "complete") as "thinking" | "complete" | "error"
                            }));
                            ...
                            setMessages([{
                                id: "initial",
                                role: "system",
                                content: `Strategy: ${found.objective}`,
        ...
        try {
            ...
            if (mission && missionId && missionId !== "new") {
                ...
                setMessages(prev => [...prev, {
                    id: `agent-${Date.now()}`,
                    role: "agent",
                    content: "Strategy activated! I'm scouting for prospects and will draft personalized emails. Check Approvals for drafts awaiting your review.",
                    timestamp: new Date(),
                    status: "complete"
                }]);
            ...
            <header className="flex items-center gap-4 px-6 h-14 border-b border-border bg-card/50">
                ...
                <div className="flex-1">
                    <h1 className="text-lg font-semibold text-foreground">
                        {mission ? mission.objective?.slice(0, 50) + "..." : "New Strategy"}
                    </h1>
                    {mission && (
