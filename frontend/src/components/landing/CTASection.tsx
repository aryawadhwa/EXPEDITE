        ...
        <div className="max-w-[90vw]">
            <motion.div style={{ opacity, y }}>
                ...
                <h2 className="text-[12vw] leading-[0.8] font-black tracking-tighter text-white mb-12">
                    ...
                    <span className="block text-transparent bg-clip-text bg-gradient-to-b from-white/80 to-white/40 ml-[10vw]">
                        YOUR
                    </span>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-12 border-t border-white/10 pt-12 mt-12">
                ...
                <div className="flex items-center gap-6">
                     <SignedIn>
                        <Link to="/dashboard">
                          <GlassButton size="lg" variant="primary" className="text-xl px-12 py-8 rounded-full">
