...
const Graphics = {
  ...
  Activate: () => (
    <div className="relative w-full h-full bg-black/40 rounded-xl border border-white/10 flex items-center justify-center overflow-hidden">
      ...
      {/* Central Node */}
      <div className="relative z-10 w-12 h-12 rounded-full bg-cyan-500/20 border border-cyan-500 flex items-center justify-center">
      ...
      {[
        ...
        <motion.div
          ...
          transition={{ repeat: Infinity, duration: 6, delay: pos.d, times: [0, 0.1, 0.8, 1] }}
        >
